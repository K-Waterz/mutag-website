            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="p-4 rounded-lg border border-[#25D366]/35 bg-[#25D366]/10">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-lg font-medium text-xs text-white bg-[#25D366] border border-[#25D366] shadow-md shadow-[#25D366]/25 transition-luxury hover:bg-[#1fb855] hover:border-[#1fb855]"
                >
