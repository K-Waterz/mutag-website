        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="p-4 rounded-lg border border-[#25D366]/35 bg-[#25D366]/10">
                <h3 className="font-medium text-[#25D366] mb-2">WhatsApp</h3>
                <p className="text-sm text-brand-light/60 mb-4">
                  Get a fast reply — tap the button below to start chatting with our team.
                </p>
                <a
                  href="https://wa.link/rgwahs"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 rounded-lg font-medium text-sm text-white bg-[#25D366] border-2 border-[#25D366] shadow-lg shadow-[#25D366]/30 transition-luxury hover:bg-[#1fb855] hover:border-[#1fb855] hover:-translate-y-0.5"
                >
